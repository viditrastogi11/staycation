...
import BookNowModal from "../Layout/BookNowModal";
...
export const RoomDetails = ({ error, details }) => {
  ...
  const newBookingHandler = async (data) => {
    const bookingData = {
      userId: user?._id,
        ...
        <div className="flex flex-col md:flex-row space-y-10 md:space-y-0 justify-between px-4">
          ...
          <div className="w-[340px] flex flex-col group">
            <div className="">
              ...
              {available === true && (
                <>
                 <button onClick={handleModalOpen} className="flex items-center justify-center px-3 py-4 bg-gradient-to-br from-blue-400 to-blue-800 text-white  rounded-md cursor-pointer w-full">
